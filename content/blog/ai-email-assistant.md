...
1. It ingests recent email and calendar activity
2. It identifies pressure points - threads that need action or restraint
3. It selects the highest-leverage move
4. It prepares the output fully
