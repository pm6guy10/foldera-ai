...
--
-- This migration recounts from scratch using tkg_signals.extracted_entity_ids
...
FROM (
  ...
  FROM tkg_signals s
  CROSS JOIN LATERAL unnest(s.extracted_entity_ids) AS unnested(entity_id)
...
-- Zero out entities that had no real-interaction signals at all
