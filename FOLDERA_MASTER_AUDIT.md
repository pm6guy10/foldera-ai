...
**Last Verified Fix:** March 18, 2026 — `330dd2e`
...
| NR5 | Removed owner-specific scorer hooks from `lib/briefing/scorer.ts` so candidate ranking no longer applies user-ID checks or identity-based suppression. | Codex follow-up | DONE — March 18, 2026, commit `330dd2e` |
| NR6 | Replaced scorer goal/domain inference hardcodes with runtime `tkg_goals` keyword indexes so goal alignment and revealed-preference checks now come from live goal rows instead of embedded titles or matching strings. | Codex follow-up | DONE — March 18, 2026, commit `330dd2e` |
| NR7 | Removed scorer-side provider/user-specific source heuristics in favor of uniform runtime goal-category inference, eliminating baked-in provider references from scoring and anti-pattern bucketing. | Codex follow-up | DONE — March 18, 2026, commit `330dd2e` |
