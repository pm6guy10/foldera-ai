...
export default function HomePage() {
  ...
  const logoCandidates = useMemo(() => [
    { src: "/foldera-logo.svg", alt: "Foldera logo" },
    { src: "/foldera-glyph.svg", alt: "Foldera glyph" },
  ], []);
      ...
      <footer className="border-t border-slate-800/50 py-10 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
            ...
            <Image src="/foldera-glyph.svg" alt="Foldera outline glyph" width={32} height={32} className="opacity-80" />
