...
async function handler(request: NextRequest) {
  ...
  try {
    ...
    // the on-demand sync-now routes call. isAutomatedTrigger: true because this whole
    ...
    const delivery = await deliverWorkdayPresence(userId, { isAutomatedTrigger: true });
