 ...
 *   NO_SEND           — cooldown active; skip generation and reuse persisted no-send evidence
 *   INSUFFICIENT_SIGNAL — no new signals / processing error; persist skipped no-send evidence
 */
