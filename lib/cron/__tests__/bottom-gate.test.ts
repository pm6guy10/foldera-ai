          ...
          topCandidates: [
            {
              ...
              targetGoal: { text: 'Interview confirmation for Alex Crisler (PM candidate) March 31', priority: 1, category: 'career' },
              sourceSignals: [],
              decision: 'selected',
              decisionReason: '',
            },
    ...
    topCandidates: [
      {
        ...
        score: 4,
        scoreBreakdown: { stakes: 4, urgency: 0.7, tractability: 0.7, freshness: 0.7, actionTypeRate: 0.7, entityPenalty: 0, final_score: 4 },
        targetGoal: null,
        sourceSignals: [],
