...
| GitHub issue #216 | `CURRENT_CONTROL` | Prove trust/privacy/no-send rail Product MVP seam (rung 4 IN_PROGRESS). | Agents and reviewers checking the current product seam. | Product/runtime implementation, queue activation, or unrelated product widening by itself. | FOLDERA_BUILD_ORDER.yaml marks issue #216 as the active Product MVP seam. |
