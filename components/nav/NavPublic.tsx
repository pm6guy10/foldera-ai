...
export function NavAuthMinimal({ variant }: { variant: 'login' | 'start' }) {
  return (
    <nav className="relative z-10 w-full px-4 sm:px-6 lg:px-12 xl:px-14 pt-[calc(1.25rem+env(safe-area-inset-top,0px))] pb-5 flex items-center justify-between max-w-[min(100%,96rem)] mx-auto border-b border-white/5 gap-3">
      <a
        href="/"
