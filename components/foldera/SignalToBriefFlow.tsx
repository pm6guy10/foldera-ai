...
export function SignalToBriefFlow() {
  return (
    <section id="product" className="relative overflow-hidden py-12 sm:py-16 lg:py-24">
      <div className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-[420px] bg-[radial-gradient(65%_70%_at_24%_10%,rgba(124,58,237,0.12),transparent_70%),radial-gradient(55%_60%_at_80%_24%,rgba(245,166,35,0.12),transparent_72%)]" />
      ...
      <div className="mx-auto max-w-[1380px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-[1fr_180px_1fr] lg:items-center">
          ...
          <div className="signal-core relative flex items-center justify-center py-2">
            ...
            <div className="relative flex h-[160px] w-[160px] items-center justify-center rounded-full border border-accent/20 bg-panel">
              <div className="signal-core__ring signal-core__ring--outer absolute inset-4 rounded-full border border-accent/25" />
              <div className="signal-core__ring signal-core__ring--inner absolute inset-8 rounded-full border border-purple-400/20" />
              <div className="signal-core__label rounded-full border border-accent/25 bg-accent/10 px-4 py-2 text-center text-[11px] font-semibold uppercase tracking-[0.14em] text-accent">
                Foldera
              </div>
            </div>
          </div>
          ...
          <div className="surface-card finished-output relative overflow-hidden p-5 sm:p-6">
            ...
            <div className="finished-output__card mt-5 rounded-[20px] border border-accent/20 bg-[#071018] p-5 shadow-[0_0_30px_rgba(245,166,35,0.12)]">
