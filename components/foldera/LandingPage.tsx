...
const slides: StorySlide[] = [
  {
    src: '/crispcanvas-storyboard/slide-1-insult.jpg',
    alt: 'Foldera â€” You are a high-paid filing clerk. Join the pilot.',
    width: 1071,
    height: 1920,
    eager: true,
    label: 'INSULT',
  ...
  {
    src: '/crispcanvas-storyboard/slide-2-tax.png',
    alt: 'The Reconstruction Tax â€” every tool switch leaks context.',
    width: 941,
    height: 1672,
    label: 'TAX',
    ordinal: '02',
  ...
  {
    src: '/crispcanvas-storyboard/slide-3-engine.png',
    alt: 'Noise in. Action out.',
    width: 941,
    height: 1672,
    label: 'ENGINE',
    ordinal: '03',
  ...
  {
    src: '/crispcanvas-storyboard/slide-4-distinction.png',
    alt: 'Start the moves.',
    width: 941,
    height: 1672,
    label: 'DISTINCT',
  ...
  {
    src: '/crispcanvas-storyboard/slide-5-habitat.png',
    alt: 'It lives where you work.',
    width: 941,
    height: 1672,
    label: 'HABITAT',
    ordinal: '05',
  ...
  {
    src: '/crispcanvas-storyboard/slide-6-kill.png',
    alt: 'Stop rebuilding. Start shipping. Join the pilot.',
    width: 941,
    height: 1672,
    label: 'KILL',
    ordinal: '06',
