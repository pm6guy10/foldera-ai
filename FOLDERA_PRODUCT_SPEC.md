...
Last Updated: March 28, 2026 (discrepancy detection live — structural gaps now primary candidates)
...
| Directive quality: housekeeping eliminated | YELLOW | Housekeeping class is partially reduced: scorer/extraction now reject paid-transaction logs and several zero-agency financial confirmations, but broader anti-generic quality still needs ongoing filter hardening (analysis-dump artifact variant remains open in backlog). |
